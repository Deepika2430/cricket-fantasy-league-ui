...
const TeamSelection = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        const userDetails = await getUserDetailsById(Cookies.get("userId"));
  ...
  useEffect(() => {
    const fetchPlayers = async () => {
      try {
        ...
        team1Data = Object.values(team1Data?.team?.players);
        team2Data = Object.values(team2Data?.team?.players);
  ...
  const handlePlayerSelect = (player: Player) => {
    ...
    if (selectedPlayers.find((p) => p.PlayerID === player.PlayerID)) return;
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between p-4  shadow-md rounded-lg">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          {!groundImageError ? (
            <div
              ...
              style={{
                backgroundImage: `url(${
                  GROUND_IMAGES[theme === "dark" ? "dark" : "light"]
                })`,
              }}
            ...
            >
              ...
              {/* Cricket pitch */}
              {/* <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-96 bg-yellow-100 rounded opacity-75"></div> */}
            ...
            // Fallback ground div when image fails to load
            <div
              className={`rounded-xl shadow-lg p-8 aspect-[2/1] relative ${
                theme === "dark" ? "bg-green-900" : "bg-green-600"
              }`}
            >
              {/* Cricket pitch */}
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-96 bg-yellow-100 rounded"></div>
              {/* Selected players */}
              <div className="relative h-full">
                {selectedPlayers.map((player, index) => (
                  <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <h2 className="text-xl font-semibold mb-4">{match.team1.Name}</h2>
          ...
          >
            <h2 className="text-xl font-semibold mb-4">{match.team2.Name}</h2>
            <div className="space-y-2">
      ...
      {showExitConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <p
              className={
                theme === "dark" ? "text-gray-300 mb-6" : "text-gray-600 mb-6"
              }
            >
